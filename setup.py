...
REPO_NAME = "GAN"
AUTHOR_USER_NAME = "DRuanli" # Modify with your github username
SRC_REPO = "GAN"
AUTHOR_EMAIL = "elio.ruanli@gmail.com" # Modify with your gmail
...
setuptools.setup(
    ...
    description="A small python package for GAN app",
